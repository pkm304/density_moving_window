...
This step extracts Tregs' coordinates and marker at varying distance from (0,1) to (99,100) um centered at each CD4 T cells (reference cells). Users can specify the distance ranges for their interest. We call each 1um interval as a shell. 
```{r}
